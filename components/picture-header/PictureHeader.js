  ...
  return (
    <div className='h-full '>
      <div className='relative w-full h-full bg-center bg-no-repeat bg-cover md:bg-local bg-picture-header'>
        <animated.div style={{
          ...springs,
        }} className='absolute p-1 bg-white rounded-full top-20 md:top-1/4 md:left-1/4 left-20 animate-bounce'>
        ...
        <animated.div style={{
          ...springs,
        }} className='absolute p-1 bg-white rounded-full top-1/2 right-10 animate-bounce'>
          <div className='relative w-10 h-10'>
        ...
        <animated.div style={{
          ...springs,
        }} className='absolute p-1 bg-white rounded-full top-1/3 md:top-2/3 left-10 animate-bounce'>
          <div className='relative w-10 h-10'>
        ...
        <animated.div style={{
          ...springs,
        }} className='absolute p-1 bg-white rounded-full top-1/3 right-10 animate-bounce'>
          <div className='relative w-10 h-10'>
        ...
        <animated.div style={{
          ...springs,
        }} className='absolute p-1 bg-white rounded-full top-1/2 left-10 animate-bounce'>
          <div className='relative w-10 h-10'>
        ...
        <h2 className='absolute text-3xl text-right rounded-2xl right-2 top-2'><span className='font-bold text-red-figma'>Web</span> Developer<br /> #OpenTo<span className='font-bold text-purple-figma'>Work</span></h2>
      </div>
    </div>
  )
}
